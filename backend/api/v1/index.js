...
router.post('/like/:recipeID?', AuthHandler.handleAuthorization, Handler.handleLike, Controller.like);
router.post('/pass/:recipeID?', AuthHandler.handleAuthorization, Handler.handlePass, Controller.pass);
